...
<x-jet-dialog-modal wire:model="modalFormVisible">
            ...
            <div class="mt-4">
                ...
                <select wire:model="label" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required>
                    <option selected default hidden value="" >Choose a Label</option>
            ...
            <div class="mt-4">
                ...
                <select wire:model="type" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-3 px-4 pr-8 round leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required>
                    <option selected default hidden value="" >Choose a Sequence</option>
