                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($list_data_from_DB as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">{{$item->registration_start_date}}</td>
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">{{$item->registration_end_date}}</td>
                                    <td class="px-6 py-4 text-sm whitespace-no-wrap">{{$item->am_status}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
