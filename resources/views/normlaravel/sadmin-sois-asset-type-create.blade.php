...
@section('page-title','SOIS|Create System Asset Type')
...
<div class="flex flex-col p-5">
    <div class="max-w-lg rounded overflow-hidden shadow-lg">
        <form name="add-articles" id="add-articles" method="POST" action="{{route('sadmin-system-assets-type.store')}}">
        @csrf
        {{ csrf_field() }}
            <div class="px-6 py-4">
                <div class="form-group">
                    <label for="type">Asset Type Name</label>
                    <input type="text" id="type" name="type" class="form-control" required="">
                </div>
                <div class="form-group">
                    <label for="asset_type_description">Asset Type Description</label>
                    <input type="text" id="asset_type_description" name="asset_type_description" class="form-control" required="">
                </div>
            </div>
