...
@section('page-title','SOIS | Edit Web Page Type')
        ...
        @method('PUT')
            <div class="px-6 py-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="page_description" name="page_description" placeholder="{{$selectPageType->page_description}}" class="form-control" >
                </div>
                @endforeach
            </div>
