...
@section('page-title','SOIS|Create Web Page Type')
...
<div class="flex flex-col p-5">
    <div class="max-w-lg rounded overflow-hidden shadow-lg">
        <form name="add-articles" id="add-articles" method="POST" action="{{route('sadmin-web-page-type.store')}}">
        @csrf
        {{ csrf_field() }}
            <div class="px-6 py-4">
                <div class="form-group">
                    <label for="page_type">Page Type Name</label>
                    <input type="text" id="page_type" name="page_type" class="form-control" required="">
                </div>
                <div class="form-group">
                    <label for="page_description">Page Type Description</label>
                    <input type="text" id="page_description" name="page_description" class="form-control" required="">
                </div>
            </div>
