...
<div class="flex flex-col p-5">
    <div class="max-w-lg rounded overflow-hidden shadow-lg">
        <form name="add-articles" id="add-articles" method="POST" action="{{route('sadmin-sois-sub-links.store')}}">
        @csrf
        {{ csrf_field() }}
            <div class="px-6 py-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="link_description" name="link_description" class="form-control" required="">
                </div>
                <div class="form-group">
                    <label for="external_link">external link</label>
                    <input type="text" id="external_link" name="external_link" class="form-control" required="">
                </div>
            </div>
