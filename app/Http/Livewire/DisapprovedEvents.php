...
class DisapprovedEvents extends Component
{
    use WithPagination;
    ...
    public function get_data_from_DB()
    {
        ...
        return DB::table('disapproved_events')
                ...
                ->where('upcoming_events.organization_id',$this->organizationData->organization_id)
    ...
    {
        return view('livewire.disapproved-events',[
