...
class OPositionTitles extends Controller
{
    /**
    ...
    {
        return view('normlaravel\oadmin-position-titles-create',[
    ...
    {
        return view('normlaravel.oadmin-position-titles-edit',[
    ...
    public function update(Request $request, $id)
    {
        ...
        PositionTitle::where('position_title_id','=',$id)->update([
         ...
         return redirect('Organization/officers')->with('status', 'Link Form Data Has Been edited');
    }
