...
class SAAnnouncementCRUD extends Controller
{
    /**
    ...
    {
        return view('normlaravel.sadmin-announcement-create');
    }
    ...
    public function store(Request $request)
    {
        ...
        // dd("Hello");
         return redirect('announcements')->with('status', 'Announcement Post Form Data Has Been inserted');
    }
